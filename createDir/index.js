...
const baseRoot = __dirname.substr(0, __dirname.indexOf('/createDir'))
const routerConfig = require(`${baseRoot}/routerConfig`);
...
const ignoreKey = ['children', 'filename'];
...
function createRouter () {
  ...
  createFile(routerDir + '/index.js', tempRouter, info, 'update')
}
